...
class MetaTagsBase(models.Model):
    ...
    meta_copyright = models.CharField(_("Copyright"), max_length=255)

    class Meta:
        abstract = True
    
    def get_meta_fields(self, name, content):
        tag = ""
        if name and content:
    ...
    def get_meta_keywords(self):
        return self.get_meta_fields("keywords", self.meta_keywords)
    
    def get_meta_description(self):
        return self.get_meta_fields("description", self.meta_description)
    
    def get_meta_author(self):
        return self.get_meta_fields("author", self.meta_author)

    def get_meta_copyright(self):
        return self.get_meta_fields("copyright", self.meta_copyright)

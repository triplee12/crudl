...
class CrudlUserCreationForm(UserCreationForm):
...
@admin.register(User)
class CrudlUserAdmin(UserAdmin):
    save_on_top = True
    list_display = ["get_avatar", "get_full_name", "download_gravatar", "is_active", "is_staff", "is_superuser"]
    list_display_links = ["get_avatar", "get_full_name",]
    ...
    add_form = CrudlUserCreationForm
    ...
    def get_avatar(self, obj):
        ...
        html = render_to_string("admin/accounts/includes/avatar.html", context={"obj":obj})
    ...
    def get_urls(self):
        ...
        def wrap(view):
            def wrapper(*args, **kargs):
                return self.admin_site.admin_view(view)(*args, **kargs)
    ...
    def download_gravatar_view(self, request, object_id):
        ...
        url = "https://www.grvatar.com/avatar/{md5_hash}?s=800&d=404".format(md5_hash=md5_hash)
...
@admin.register(Role)
class CrudlRoleAdmin(GroupAdmin):
